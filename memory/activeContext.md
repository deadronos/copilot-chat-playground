...
- Execute monolith refactor Phase 3 (`TASK020`) — cleanup, docs, CI guardrails (in progress).
...
- 2026-01-25: Added CI coverage thresholds + router thinness guard and documented post-refactor module layout (TASK020).
...
6. Finish `TASK020`: run typecheck/tests and finalize cleanup.
